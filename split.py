...
parser.add_argument('--train', type=float, default=0.8, help='fraction of data for training')
parser.add_argument('--val', type=float, default=0.1, help='fraction of data for validation')
parser.add_argument('--test', type=float, default=0.1, help='fraction of data for testing')
...
with h5py.File(args.filename, 'r') as f:
    ...
    train, val, test = np.split(frames, [int(args.train*len(frames)), int((args.train+args.val)*len(frames))])
